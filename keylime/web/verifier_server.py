...
class VerifierServer(Server):
    ...
    def _routes(self):
        ...
        self._get(
            "/v:version/agents/:agent_id/attestations/:index", PushAttestationController, "show", allow_insecure=True
        )
        self._get(
            "/v:version/agents/:agent_id/attestations/latest",
            PushAttestationController,
            "show_latest",
            allow_insecure=True,
        )
