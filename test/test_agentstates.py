...
class TestTPMState(unittest.TestCase):
    def test_initial_pcr_value(self):
        ...
        self.assertEqual(tpm_state.initial_pcr_value(0, hash), hash.get_start_hash())
        self.assertEqual(tpm_state.initial_pcr_value(2, hash), hash.get_start_hash())
        self.assertEqual(tpm_state.initial_pcr_value(16, hash), hash.get_start_hash())
        self.assertEqual(tpm_state.initial_pcr_value(17, hash), hash.get_ff_hash())
        self.assertEqual(tpm_state.initial_pcr_value(18, hash), hash.get_ff_hash())
        self.assertEqual(tpm_state.initial_pcr_value(23, hash), hash.get_ff_hash())
    ...
    def test_init_pcr(self):
        ...
        tpm_state.init_pcr(0, hash)
        self.assertEqual(tpm_state.get_pcr(0), hash.get_start_hash())
        ...
        tpm_state.init_pcr(16, hash)
        self.assertEqual(tpm_state.get_pcr(16), hash.get_start_hash())

        # now check a couple of FF hash ones
        self.assertIsNone(tpm_state.get_pcr(17))
        tpm_state.init_pcr(17, hash)
        self.assertEqual(tpm_state.get_pcr(17), hash.get_ff_hash())

        self.assertIsNone(tpm_state.get_pcr(23))
        tpm_state.init_pcr(23, hash)
        self.assertEqual(tpm_state.get_pcr(23), hash.get_ff_hash())
